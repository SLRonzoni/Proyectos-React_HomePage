    ...
    return(
        <div className="home">
            ...
            <Container>
                ...
                <br></br>          
                <Row>
                <h2 className="text-primary">Experiencia laboral</h2>
                <br></br>     
                <br></br> 
                <div className="row">
                    <div className="col-sm-6">
                        ...
                        <div className="card-body">
                            ...
                            <p></p>
                           <a href ='http://prosegur.com.ar' className="link btn btn-primary">Ver la empresa</a>
                        </div>
                        </div>
                    </div>
                    <div className="col-sm-6">
                        ...
                        <div className="card-body">
                            ...
                            <p></p>
                            <a href= 'http://unionbat.com.ar' className="link btn btn-primary">Ver la empresa</a>
                        </div>
                        </div>
                    </div>
                    </div>
